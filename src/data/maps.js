...
export const MAPS = {
  ...
  theEyrie: {
    ...
    npcs: [
      ...
      { x: 9, y: 25, dir: 'up', sprite: 'maester', name: 'Maester Colemon', script: 'townTalk',
        data: { line: 'Maester Colemon: Six hundred steps. I have counted them going up and going down and got a different number twice, and I no longer trust the count or my knees.' } },
  ...
  highgarden: makeTown({
    ...
    npcs: [
      ...
      { x: 13, y: 5, dir: 'down', sprite: 'maester', name: 'Maester Lomys',
        script: 'townTalk', data: { line: 'Maester Lomys: Half the Reach is somebody\u2019s cousin. Bring me a hall and a name that has bent to you, and a match is the easiest thing in the world to draw up.' } },
  ...
  sunspear: makeTown({
    outsiders: [
      ...
      { dir: 'down', sprite: 'maester', name: 'Maester Caleotte', script: 'townTalk',
        data: { line: 'Maester Caleotte: Water, shade, or somewhere to sit. In the shadow city all three cost the same, and a man who has walked from the gate wants all three.' } },
    ],
  ...
  stormsEnd: makeTown({
    outsiders: [
      ...
      { dir: 'down', sprite: 'maester', name: 'Maester Jurne', script: 'townTalk',
        data: { line: 'Maester Jurne: When the bell goes you are already too late to be off the cliff. I write that in the book every year, and every year they ring it anyway.' } },
    ],
  ...
  dragonstone: makeTown({
    ...
    npcs: [
      ...
      { x: 17, y: 16, dir: 'down', sprite: 'maester', name: 'Maester Cressen',
        script: 'townTalk',
        data: { line: 'Maester Cressen: The ground is warm here in midwinter. I have '
          + 'written to three citadels asking why. Two did not answer, and the third '
  ...
  riverrun: {
    ...
    npcs: [
      { x: 15, y: 8, dir: 'down', sprite: 'tully', name: 'Ser Brynden Tully', script: 'duel',
        data: { duel: 'hedgeKnight' } },
      ...
      { x: 10, y: 16, dir: 'down', sprite: 'maester', name: 'Maester Vyman',
        script: 'townTalk', data: { line: 'Maester Vyman: A match is arranged, not fallen into. Bring me a hall to send her to and the coin to do it properly, and I will draw up the rest.' } },
  ...
  lannisport: {
    ...
    npcs: [
      ...
      { x: 20, y: 25, dir: 'up', sprite: 'maester', name: 'Maester Creylen', script: 'townTalk',
        data: { line: 'Maester Creylen: The Rock sends its gold up the road and its herring down to the quay. I am asked to write down which is the greater sum, and to be tactful about the answer.' } },
  ...
  lannisportForge: {
    ...
    npcs: [
      { x: 7, y: 1, dir: 'down', sprite: 'merchant', name: 'Armourer', script: 'smith',
        data: { line: 'Armourer: Gold pays for good steel, and this city has both.',
          stock: { weapon: ['castleForged', 'bastardSword', 'halberd', 'warhammer'],
            armour: ['ringmail', 'scaleArmour', 'bandedMail'],
            helm: ['kettleHat', 'bascinet', 'greatHelm'],
            gloves: ['splintedGauntlets', 'plateGauntlets'],
            shield: ['oakShield', 'ironboundShield', 'kiteShield'] } } },
  ...
  /* Casterly Rock is not a castle standing on a hill, it is halls cut out of
     the hill. Three of them, one above the next, joined by stairs in the living
     rock: the lord's hall at the top, the Golden Gallery under it with the gold
     still in it, the Hall of Heroes under that, and the Lion's Mouth running
  ...
  casterlyRock: {
    ...
    signs: [
      ...
      { x: 4, y: 11, text: 'THE GOLDEN GALLERY\nThe gold is still in the walls and always was.\nThat is the whole of how this house happened.' },
      { x: 12, y: 21, text: "THE LION'S MOUTH\nThe tunnel down to Lannisport.\nWide enough for twenty men abreast, which was the point." },
    ],
    npcs: [
      { x: 12, y: 4, dir: 'down', sprite: 'lannister', name: 'Ser Jaime', script: 'gymLannister',
        data: { trainer: 'gymLannister' } },
      { x: 6, y: 11, dir: 'right', sprite: 'lannister', name: 'Ser Kevan', script: 'trainer',
        data: { trainer: 'lionKnight1' } },
      { x: 18, y: 13, dir: 'left', sprite: 'lannister', name: 'Ser Addam', script: 'trainer',
        data: { trainer: 'lionKnight2' } },
      { x: 8, y: 19, dir: 'right', sprite: 'child', name: 'Page', script: 'gymHintLannister' },
      { x: 17, y: 3, dir: 'down', sprite: 'mountain', name: 'Gregor Clegane', script: 'duel',
        data: { duel: 'mountain' } },
      { x: 7, y: 3, dir: 'down', sprite: 'lannister', name: 'Ser Jaime', script: 'duel',
        data: { duel: 'jaime' } },
    ],
  },
  ...
  pyke: {
    ...
    npcs: [
      ...
      { x: 30, y: 22, dir: 'left', sprite: 'maester', name: 'Maester Wendamyr', script: 'townTalk',
        data: { line: 'Maester Wendamyr: I keep the ravens and the tallies for a house that counts in ships and drowned men. The ledger is short. The sea is not.' } },
  ...
  klArmoury: {
    ...
    npcs: [
      { x: 7, y: 1, dir: 'down', sprite: 'merchant', name: 'Armourer', script: 'smith',
        data: { line: 'Armourer: The Kingsguard are fitted here. So is anybody who can pay what they cost.',
          stock: { weapon: ['bastardSword', 'greatsword', 'direWarhammer', 'poleaxe'],
            armour: ['knightPlate', 'splintMail', 'halfPlate'],
            helm: ['greatHelm', 'sallet', 'armet'],
            gloves: ['plateGauntlets', 'dragonscaleGrips'],
            shield: ['towerShield', 'kiteShield', 'scutum'] } } },
