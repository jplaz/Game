...
export const MAPS = {
  ...
  kingsroadNorth: makeRoute({
    ...
    encounters: [
      { species: 'snowpup', min: 12, max: 16, weight: 20 },
      { species: 'bearcub', min: 13, max: 17, weight: 18 },
      { species: 'wightling', min: 14, max: 18, weight: 18 },
      { species: 'ravenling', min: 12, max: 16, weight: 16 },
      { species: 'direwolf', min: 16, max: 19, weight: 12 },
      { species: 'falconet', min: 13, max: 17, weight: 16 },
    ],
    warps: [
  ...
  beyondTheWall: makeRoute({
    ...
    encounters: [
      { species: 'wightling', min: 28, max: 34, weight: 26 },
      { species: 'barrowlord', min: 32, max: 38, weight: 14 },
      { species: 'direwolf', min: 28, max: 33, weight: 18 },
      { species: 'bearhold', min: 30, max: 36, weight: 14 },
      { species: 'winterfang', min: 34, max: 39, weight: 10 },
      { species: 'ravenling', min: 26, max: 30, weight: 18 },
    ],
    warps: [
  ...
  bloodyGate: makeRoute({
    ...
    encounters: [
      { species: 'falconet', min: 22, max: 27, weight: 26 },
      { species: 'skytalon', min: 26, max: 30, weight: 10 },
      { species: 'boartusk', min: 22, max: 26, weight: 18 },
      { species: 'cubmane', min: 22, max: 26, weight: 16 },
      { species: 'crabcrag', min: 23, max: 27, weight: 14 },
      { species: 'ravenling', min: 21, max: 25, weight: 16 },
    ],
    warps: [
  ...
  roseroad: makeRoute({
    ...
    encounters: [
      { species: 'fawnhart', min: 26, max: 31, weight: 20 },
      { species: 'sapling', min: 26, max: 31, weight: 18 },
      { species: 'heartwarden', min: 32, max: 36, weight: 8 },
      { species: 'cubmane', min: 27, max: 31, weight: 16 },
      { species: 'boartusk', min: 27, max: 31, weight: 16 },
      { species: 'emberwisp', min: 28, max: 32, weight: 12 },
      { species: 'riverfry', min: 26, max: 30, weight: 10 },
    ],
    warps: [
  ...
  princesPass: makeRoute({
    ...
    encounters: [
      { species: 'sandviper', min: 30, max: 35, weight: 24 },
      { species: 'dornspine', min: 34, max: 38, weight: 10 },
      { species: 'emberwisp', min: 30, max: 34, weight: 18 },
      { species: 'cubmane', min: 30, max: 34, weight: 16 },
      { species: 'falconet', min: 30, max: 34, weight: 16 },
      { species: 'crabcrag', min: 31, max: 35, weight: 16 },
    ],
    warps: [
  ...
  stormlands: makeRoute({
    ...
    encounters: [
      { species: 'fawnhart', min: 28, max: 33, weight: 20 },
      { species: 'crownstag', min: 33, max: 37, weight: 10 },
      { species: 'falconet', min: 28, max: 32, weight: 18 },
      { species: 'krakenling', min: 29, max: 33, weight: 16 },
      { species: 'boartusk', min: 28, max: 32, weight: 18 },
      { species: 'riverfry', min: 28, max: 32, weight: 18 },
    ],
    warps: [
  ...
  dragonmont: {
    ...
    encounters: [
      { species: 'emberwisp', min: 34, max: 40, weight: 26 },
      { species: 'pyremaw', min: 40, max: 45, weight: 12 },
      { species: 'scaleflight', min: 36, max: 42, weight: 18 },
      { species: 'sandviper', min: 34, max: 39, weight: 16 },
      { species: 'crabcrag', min: 34, max: 39, weight: 14 },
      { species: 'dreadwyrm', min: 44, max: 48, weight: 6 },
    ],
    warps: [
